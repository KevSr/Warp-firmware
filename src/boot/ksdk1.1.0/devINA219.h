...
typedef enum
{
    ...
    INA219_CONFIG_BVOLTAGERANGE_MASK        = 0x0000,
    /** bus voltage range values **/
    INA219_CONFIG_BVOLTAGERANGE_16V         = 0x0000, // 0-16V Range
    INA219_CONFIG_BVOLTAGERANGE_32V         = 0x2000, // 0-32V Range
    /** mask for gain bits **/
    INA219_CONFIG_GAIN_MASK                 = 0x0000,
    /** values for gain bits **/
    INA219_CONFIG_GAIN_1_40MV               = 0x0000,  // Gain 1, 40mV Range
    INA219_CONFIG_GAIN_2_80MV               = 0x8000,  // Gain 2, 80mV Range
    INA219_CONFIG_GAIN_4_160MV              = 0x1000, // Gain 4, 160mV Range
    INA219_CONFIG_GAIN_8_320MV              = 0x1800, // Gain 8, 320mV Range
    /** mask for bus ADC resolution bits **/
    INA219_CONFIG_BADCRES_MASK              = 0x0180,
    ...
    INA219_CONFIG_SADCRES_MASK              = 0x0018,
...
/** values for operating mode **/
    INA219_CONFIG_MODE_POWERDOWN            = 0x0000, // Power-Down
    INA219_CONFIG_MODE_SVOLT_TRIGGERED      = 0x0001, // Shunt Voltage, Triggered
    INA219_CONFIG_MODE_BVOLT_TRIGGERED      = 0x0002, // Bus Voltage, Triggered
    INA219_CONFIG_MODE_SANDBVOLT_TRIGGERED  = 0x0003, // Shunt and Bus, Triggered
    INA219_CONFIG_MODE_ADCOFF               = 0x0004, // ADC Off (disabled)
    INA219_CONFIG_MODE_SVOLT_CONTINUOUS     = 0x0005, // Shunt Voltage, Continuous
    INA219_CONFIG_MODE_BVOLT_CONTINUOUS     = 0x0006, // Bus Voltage, Continuous
    INA219_CONFIG_MODE_SANDBVOLT_CONTINUOUS = 0x0007, // Shunt and Bus, Continuous
}INA219Commands;
